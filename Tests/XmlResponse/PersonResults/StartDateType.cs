...
{
	public class StartDateType : Altova.Xml.Node
	{
		#region Forward constructors

		public StartDateType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public StartDateType(XmlNode node) : base(node) { SetCollectionParents(); }
		public StartDateType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public StartDateType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
        ...
        {
            StartDateType parent;
            public StartDateType Parent
			{
				set
				{
					parent = value;
        ...
        public class DateEnumerator: IEnumerator 
        {
			int nIndex;
			StartDateType parent;
			public DateEnumerator(StartDateType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class ClockEnumerator: IEnumerator 
        {
			int nIndex;
			StartDateType parent;
			public ClockEnumerator(StartDateType par) 
			{
				parent = par;
				nIndex = -1;
			}
