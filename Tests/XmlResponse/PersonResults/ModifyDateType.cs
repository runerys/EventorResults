...
{
	public class ModifyDateType : Altova.Xml.Node
	{
		#region Forward constructors

		public ModifyDateType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public ModifyDateType(XmlNode node) : base(node) { SetCollectionParents(); }
		public ModifyDateType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public ModifyDateType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
        ...
        {
            ModifyDateType parent;
            public ModifyDateType Parent
			{
				set
				{
					parent = value;
        ...
        public class DateEnumerator: IEnumerator 
        {
			int nIndex;
			ModifyDateType parent;
			public DateEnumerator(ModifyDateType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class ClockEnumerator: IEnumerator 
        {
			int nIndex;
			ModifyDateType parent;
			public ClockEnumerator(ModifyDateType par) 
			{
				parent = par;
				nIndex = -1;
			}
