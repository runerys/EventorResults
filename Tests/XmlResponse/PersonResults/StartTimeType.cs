...
{
	public class StartTimeType : Altova.Xml.Node
	{
		#region Forward constructors

		public StartTimeType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public StartTimeType(XmlNode node) : base(node) { SetCollectionParents(); }
		public StartTimeType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public StartTimeType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
        ...
        {
            StartTimeType parent;
            public StartTimeType Parent
			{
				set
				{
					parent = value;
        ...
        public class DateEnumerator: IEnumerator 
        {
			int nIndex;
			StartTimeType parent;
			public DateEnumerator(StartTimeType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class ClockEnumerator: IEnumerator 
        {
			int nIndex;
			StartTimeType parent;
			public ClockEnumerator(StartTimeType par) 
			{
				parent = par;
				nIndex = -1;
			}
