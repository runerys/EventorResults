...
{
	public class Alpha2Type : Altova.Xml.Node
	{
		#region Forward constructors

		public Alpha2Type(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public Alpha2Type(XmlNode node) : base(node) { SetCollectionParents(); }
		public Alpha2Type(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public Alpha2Type(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		{
			return new valueType(GetDomNodeValue(GetDomChildAt(NodeType.Attribute, "", "value", index)));
		}
		...
		public valueType Getvalue2ValueAtCursor( XmlNode curNode )
		{
			if( curNode == null )
				...
				return new valueType( curNode.Value );
		}
        ...
        public class value2Enumerator: IEnumerator 
        {
			int nIndex;
			Alpha2Type parent;
			public value2Enumerator(Alpha2Type par) 
			{
				parent = par;
				nIndex = -1;
			}
