...
{
	public class CountryIdType : Altova.Xml.Node
	{
		#region Forward constructors

		public CountryIdType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public CountryIdType(XmlNode node) : base(node) { SetCollectionParents(); }
		public CountryIdType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public CountryIdType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public valueType4 Newvalue2()
		{
			return new valueType4();
		}

		public valueType4 Getvalue2At(int index)
		{
			return new valueType4(GetDomNodeValue(GetDomChildAt(NodeType.Attribute, "", "value", index)));
		}
		...
		public valueType4 Getvalue2ValueAtCursor( XmlNode curNode )
		{
			if( curNode == null )
				...
				return new valueType4( curNode.Value );
		}
        ...
        {
            CountryIdType parent;
            public CountryIdType Parent
			{
				set
				{
					parent = value;
        ...
        public class value2Enumerator: IEnumerator 
        {
			int nIndex;
			CountryIdType parent;
			public value2Enumerator(CountryIdType par) 
			{
				parent = par;
				nIndex = -1;
			}
