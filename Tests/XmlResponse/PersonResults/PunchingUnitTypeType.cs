...
{
	public class PunchingUnitTypeType : Altova.Xml.Node
	{
		#region Forward constructors

		public PunchingUnitTypeType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public PunchingUnitTypeType(XmlNode node) : base(node) { SetCollectionParents(); }
		public PunchingUnitTypeType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public PunchingUnitTypeType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public valueType6 Newvalue2()
		{
			return new valueType6();
		}

		public valueType6 Getvalue2At(int index)
		{
			return new valueType6(GetDomNodeValue(GetDomChildAt(NodeType.Attribute, "", "value", index)));
		}
		...
		public valueType6 Getvalue2ValueAtCursor( XmlNode curNode )
		{
			if( curNode == null )
				  throw new Altova.Xml.XmlException("Out of range");
			else
				return new valueType6( curNode.Value );
		}


		public valueType6 Getvalue2()
		{
			return Getvalue2At(0);
		}

		public valueType6 value2
		{
			get
			{
				return Getvalue2At(0);
		...
		public void Addvalue2(valueType6 newValue)
		{
			if( newValue.IsNull() == false )
				AppendDomChild(NodeType.Attribute, "", "value", newValue.ToString());
		}

		public void Insertvalue2At(valueType6 newValue, int index)
		{
			if( newValue.IsNull() == false )
				InsertDomChildAt(NodeType.Attribute, "", "value", index, newValue.ToString());
		}

		public void Replacevalue2At(valueType6 newValue, int index)
		{
        ...
        {
            PunchingUnitTypeType parent;
            public PunchingUnitTypeType Parent
			{
				set
				{
					parent = value;
        ...
        public class value2Enumerator: IEnumerator 
        {
			int nIndex;
			PunchingUnitTypeType parent;
			public value2Enumerator(PunchingUnitTypeType par) 
			{
				parent = par;
				nIndex = -1;
			}
